...
class Demand
{
    ...
    public const AMENDMENT_TYPES = ['federal', 'estadual', 'municipal', 'outros'];
    ...
    {
        $sql = 'INSERT INTO demandas (emenda, nome_politico, numero_processo_sei, tipo_processo, tipo_processo_outros, tipo_emenda, tipo_emenda_outros, data_prazo_resposta, data_cadastro_emenda,
                    observacao, anexo_emenda, anexo_nome_original, funcionario_id, status, criado_por, data_ultima_atualizacao)
                VALUES (:emenda, :nome_politico, :numero_processo_sei, :tipo_processo, :tipo_processo_outros, :tipo_emenda, :tipo_emenda_outros, :data_prazo_resposta, :data_cadastro_emenda,
    ...
    public function update(int $id, array $data): bool
    {
        $sql = 'UPDATE demandas
                SET emenda = :emenda,
                    ...
                    tipo_emenda_outros = :tipo_emenda_outros,
